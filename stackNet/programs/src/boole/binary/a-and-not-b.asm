* a-and-not-b.asm — bitwise a AND NOT b (a ↛ b), stop when either tape ends *
...
NAND       * [..., NAND(a, NOT b)] — NAND(a, NOT b) *
DUP        * [..., NAND(a, NOT b), NAND(a, NOT b)] *
NAND       * [..., a AND NOT b]    — negate → AND *
POP        *                       — emit result *
